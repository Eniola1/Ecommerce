...
<div id = "top">  </div> 
 ...
 <div id = "left"> <h2 style = " color: white; font-family: calibri; font-size: 25px; margin-left: 10px;"> Manage Content </h2> 
 ...
 <div id = "right">
 <br>
 <h2 style = "color:black; font-family:calibri; align:center;"><?php echo @$_GET['logged_in']; ?></h2> 
